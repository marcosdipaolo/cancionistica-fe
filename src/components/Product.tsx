        ...
        <div className="container">
            <div className="row">
                <div className="col-md-4 prod text-center animate-box">
                    <div className="product" style={{backgroundImage: 'url(images/img-9.jpg)'}}>
                ...
                <div className="col-md-4 prod text-center animate-box">
                    <div className="product" style={{backgroundImage: 'url(images/img-11.jpg'}}>
                        <a href="#" className="view">
                            <i className="icon-plus" />
                        </a>
                    </div>
                ...
                <div className="col-md-4 prod text-center animate-box">
                    <div className="product" style={{backgroundImage: 'url(images/img-12.jpg'}}>
                        <a href="#" className="view">
                            <i className="icon-plus" />
                        </a>
                    </div>
