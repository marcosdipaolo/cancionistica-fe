...
const AboutUs: FC = () => (
    <div>
        <div id="fh5co-intro-section">
            <SectionTitle title="About us" sub="Lorem ipsum dolor sit amet, consectetur.2"/>
        </div>
                    ...
                    <div className="col-md-8 col-md-offset-2 text-center animate-box">
                        <div className="about-content">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse quo est quis mollitia
                                ...
                                sunt ea praesentium expedita numquam. Quos quia provident consequuntur culpa facere
                                ratione maxime commodi voluptates id repellat velit eaque aspernatur expedita.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
