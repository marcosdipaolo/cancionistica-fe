...
const ChangePasswordForm: FC = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      newPassword: Yup.string().min(6, "Mínimo 6 caracteres").required("La contraseña actual es requerida"),
      newPasswordConfirmation: Yup.string().required("La confirmación es requerida").oneOf([ Yup.ref('newPassword'), null ], 'Las contraseñas nuevas deben coincidir'),
    })
  });
